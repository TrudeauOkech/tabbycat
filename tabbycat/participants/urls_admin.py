...
urlpatterns = [
    ...
    path('team/<int:team_id>/speaker/add/',
        views.CreateSpeakerView.as_view(),
        name='participants-speaker-add'),
    path('speaker/<int:pk>/delete/',
        views.DeleteSpeakerView.as_view(),
        name='participants-speaker-delete'),
